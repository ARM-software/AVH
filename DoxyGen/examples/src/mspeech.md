...
![AWS AMI subscription button](images/subscribe.png)
...
![AWS instance size list](images/instance_type.png)
...
![AWS instance size list](images/ec2_vpc.png)
...
![AWS instance size list](images/ec2_sg.png)
...
![AWS key pair selection menu](images/key_pair.png)
...
![AWS key pair selection menu](images/ec2_launch.png)
...
![MobaXterm SSH configuration](images/moba_ssh.png)
...
![PuTTY username and hostname/IP configuration](images/putty_ip.png)

* Specify path to `key.pem` in *Session > Connection > SSH > Auth > Private key file for authentication*

![PuTTY private key configuration](images/putty_key.png)
...
1. Start a SSH tunnel to the instance and forward port 8080. On Linux, MacOS or [Windows Powershell](https://www.howtogeek.com/336775/how-to-enable-and-use-windows-10s-built-in-ssh-commands/):
    ...
    * Start the tunnel connection
    ...
    ![MobaXterm SSH tunnel configuration](images/moba_tunnel.png)
...
3. Forward port 5901 on local machine​. On Linux, MacOS or [Windows Powershell](https://www.howtogeek.com/336775/how-to-enable-and-use-windows-10s-built-in-ssh-commands/):
    ...
    * Select the *Network settings* tab configure the *SSH gateway* with:
    ...
    ![MobaXterm VNC configuration through SSH gateway](images/moba_vnc.png)
...
2. Add `New self-hosted runner`
    ...
    ![GitHub New self-hosted runner button](images/github_newrunner.png)

3. Select Linux, x64 Runner image and copy the commands to set up

    ![GitHub Self-hosted runner configuration instructions](images/github_createrunner.png)
...
![GitHub runner list](images/github_idlerunner.png)
...
4. In GitHub, locate the *Actions* sections and inspect the history of the workflow runs on the AMI instance
    ...
    ![GitHub actions reports](images/github_actionreports.png)
...
3. Observe in AMI that the runner reports failure
    ...
    ![GitHub actions reports](images/github_actionreports_failed.png)
...
Have questions, comments, or suggestions? Visit the [Arm Virtual Hardware support forum](https://community.arm.com/support-forums/f/arm-virtual-hardware-targets-forum)

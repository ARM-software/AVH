...
// fill array
 arr.push( new tabElement( "Overview",       "/overview/html/",        "Overview"       ));
 arr.push( new tabElement( "Simulation",     "/simulation/html/",      "Simulation"     ));
 arr.push( new tabElement( "Infrastructure", "/infrastructure/html/",  "Infrastructure" ));
 arr.push( new tabElement( "Examples",       "/examples/html/",        "Examples"       ));
